...
/**
 * Created by chendd on 2017/2/13.
 */

public class CreateValueFiles {

    private int baseW;
    private int baseH;
    //    private String dirStr = "./res";
    private String dirStr = "./screenadapter/src/main/res";
    private final static String WTemplate = "<dimen name=\"dp{0}\">{1}dp</dimen>\n";
    private final static String HTemplate = "<dimen name=\"dp{0}\">{1}dp</dimen>\n";
    private final static String VALUE_TEMPLATE = "values-land-xhdpi";
    ...
    public CreateValueFiles(int baseX, int baseY, String supportStr) {
        this.baseW = baseX;
        this.baseH = baseY;
